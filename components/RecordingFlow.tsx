    ...
    try {
      ...
      const updated: Lecture = {
        ...
        statusMessage: recovered
          ? `Microphone session ended, but ${result.chunkCount} saved checkpoint${result.chunkCount === 1 ? '' : 's'} were assembled and playback-verified · ready to transcribe`
          : `Audio playback verified · ${result.chunkCount} checkpoint${result.chunkCount === 1 ? '' : 's'} saved · ready to transcribe`,
