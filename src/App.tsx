...
const defaultSettings: AppSettings = { key: 'app', consentAcknowledged: false, followTranscript: true, preferredMode: 'maximum', phoneModelInstalled: false };
      ...
      try {
        ...
        await update({
          ...
          statusMessage: isPhoneOrTablet()
            ? 'Recording safely saved · choose Transcribe on Phone or Maximum Accuracy on Computer'
            : 'Recording safely saved · start the Windows helper for Maximum Accuracy, or use the on-device model',
        });
      } catch (error) {
