...
assert.match(worker, /Retrying with/);
...
console.log('✓ iPhone/iPad clean recording, distant-speech transcription, sharing, and Windows-transfer safeguards are present');
